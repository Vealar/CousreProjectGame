...
public class PlayerGroundState : State
{
    ...
    {
        context.rigidbody2D.linearDamping = 0f; 
    ...
    public override void UpdateState()
    {
        ...
        if(!context.isDashing){
            context.rigidbody2D.linearVelocity = new Vector2(context.targetXaxis * context.groundSpeed, context.rigidbody2D.linearVelocity.y);
        }
    }
